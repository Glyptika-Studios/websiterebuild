...
VALUES
  ...
  ('22222222-0000-0000-0000-000000000003',
   ...
   'IMS Platform streamlines internal operations ΓÇö HR, inventory, approvals, and reporting ΓÇö in a single unified dashboard.',
...
INSERT INTO proposals (
  ...
  'range', 500000, 1500000, 'Γé╣5L ΓÇô Γé╣15L',
  'website', 'high', 'new'
);
