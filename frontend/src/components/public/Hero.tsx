      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#E8F0FE] text-[#1A73E8] text-sm font-semibold tracking-wide mb-8 border border-[#D2E3FC] shadow-sm"
          >
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#111827] tracking-tight mb-5 leading-tight">
            ...
            <p className="text-xl md:text-2xl text-[#6B7280] max-w-4xl mx-auto mb-12 font-normal leading-relaxed">
          ...
          >
            <Link
              href="#services"
              className="group inline-flex items-center gap-2.5 px-7 py-3.5 rounded-xl text-base font-bold text-white bg-[#2563EB] hover:bg-[#1D4ED8] shadow-[0_10px_24px_rgba(37,99,235,0.20)] hover:-translate-y-0.5 active:scale-[0.98] transition-all duration-200"
            >
            ...
            <Link
              href="#products"
              className="group inline-flex items-center gap-2.5 px-7 py-3.5 rounded-xl text-base font-bold text-[#2563EB] bg-white border border-[#2563EB] hover:bg-[#F3F7FF] shadow-sm hover:-translate-y-0.5 active:scale-[0.98] transition-all duration-200"
            >
          ...
          >
            {serviceCards.map((card, idx) => (
              <motion.div
                ...
                whileHover={{ y: -2 }}
                className="group flex flex-col items-center justify-center text-center gap-2.5 p-6 rounded-[20px] bg-white border border-[#DCE3EC] shadow-[0_16px_36px_rgba(15,23,42,0.05)] hover:-translate-y-1 hover:border-[#2563EB]/40 hover:shadow-[0_24px_48px_rgba(37,99,235,0.12)] transition-all duration-250 cursor-default"
              >
                <span
                ...
                <span className="text-sm text-[#5F6368] leading-snug">{card.desc}</span>
              </motion.div>
            ))}
          </motion.div>
