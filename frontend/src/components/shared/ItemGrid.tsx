              ...
              {item.tags && item.tags.length > 0 && (
                <div className="flex flex-wrap gap-1.5 mb-6">
                  {item.tags.map((tag) => (
                    <span
                      key={tag}
                      className="px-2.5 py-0.5 rounded-md bg-[#EFF6FF] border border-[#BFDBFE] text-[#2563EB] text-[10px] font-bold uppercase tracking-wider"
                    >
                      #{tag}
                    </span>
                  ))}
        ...
        {selectedItem && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="text-[#6B7280] text-base leading-relaxed border-t border-[#E5E7EB] pt-4 whitespace-pre-line">
                {selectedItem.fullDescription || selectedItem.description || "Bespoke custom-engineered solution designed to optimize security, time efficiency, and operational accuracy."}
              </div>
