...
const SIDEBAR_ITEMS: SidebarItem[] = [
  ...
  { name: "Products", href: "/admin/products", icon: Briefcase, permission: "products" },
  ...
  { name: "Services", href: "/admin/services", icon: Layers, permission: "home" },
  { name: "CMS Editors", href: "/admin/cms", icon: Settings, permission: "home" },
  { name: "Proposals", href: "/admin/proposals", icon: Mail, permission: "home" },
